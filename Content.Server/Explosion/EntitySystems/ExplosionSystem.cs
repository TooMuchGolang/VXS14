...
public sealed partial class ExplosionSystem : EntitySystem
{
    ...
    public float IntensityToRadius(float totalIntensity, float slope, float maxIntensity)
    {
        ...
        return r0 * (MathF.Sqrt(24 * totalIntensity / v0 - 3) / 6 + 0.5f);
    }
        ...
        bool canCreateVacuum)
    {
        ...
        // camera shake
        CameraShake(iterationIntensity.Count * 6.5f, epicenter, totalIntensity);
        ...
        var audioRange = Math.Min(iterationIntensity.Count * 4, MaxExplosionAudioRange);
