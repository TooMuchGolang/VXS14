...
ent-VendingMachineRestockChemVend = набор пополнения ХимВенд
    .desc = Коробка, наполненная химикатами, и обклеенная опасно-ромбического вида наклейками, предостерегающими и инструктирующими на случай чрезвычайной ситуациии. Поместите в слот для пополнения ХимВенд, чтобы начать.
