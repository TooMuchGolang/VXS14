...
ent-CrateEvaKit = набор EVA
    .desc = Ящик, содержащий две пары скафандров ЕВА вместе с шлемами.
ent-CrateEngineeringPowercell = ящик батареек
    .desc = Ящик, содержащий три батарейки средней ёмкости.
